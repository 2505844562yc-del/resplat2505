...
# Train only the zero-initialized semantic-state head with explicit semantic
# render residual feedback. Usage: bash scripts/v3_semantic_residual_overfit.sh [steps]

STEPS="${1:-20}"
SCENE="032dee9fb0a8bc1b90871dc5fe950080d0bcd3caf166447f44e60ca50ac04ec7"
OUT="outputs/v3_semantic_residual/${STEPS}steps"
