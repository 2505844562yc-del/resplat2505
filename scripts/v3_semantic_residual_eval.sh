...
# Usage: bash scripts/v3_semantic_residual_eval.sh [steps] [test_len]
STEPS="${1:-20}"
TEST_LEN="${2:-5}"
TRAIN_OUT="outputs/v3_semantic_residual/${STEPS}steps"
EVAL_OUT="outputs/v3_semantic_residual/${STEPS}steps_eval"
