...
# Train the semantic-state head with rasterizer-VJP-aligned semantic feedback.
# Usage: bash scripts/v3_semantic_vjp_overfit.sh [steps]

STEPS="${1:-20}"
SCENE="032dee9fb0a8bc1b90871dc5fe950080d0bcd3caf166447f44e60ca50ac04ec7"
OUT="outputs/v3_semantic_vjp/${STEPS}steps"
